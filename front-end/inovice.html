			  ...
			  <div class="col-lg-8 col-md-8 col-12">
				<div class="topbar-social text-center text-md-right">
				  <ul class="list-inline d-md-flex justify-content-end">
					<li class="ms-10 pe-10"><a href="#"><i class="text-white fa fa-envelope"></i> info@Rhythm.com</a></li>
		...
		<nav hidden class="nav-white nav-transparent">
			<div class="nav-header">
				<a href="index.html" class="brand">
					<img src="../images/logo-light-text2.png" class="img-fluid" alt=""/>
				</a>
			...
			<div class="row">
				<div class="col-12">
					<div class="text-center">						
						<h2 class="page-title text-white">Invoice</h2>
				...
				<div class="box-body">					
				  ...
				  <div class="row invoice-info">
					<div class="col-md-6 invoice-col">
					  <strong>From</strong>	
					  <address>
						<strong class="text-blue fs-24">Rhythm</strong><br>
					...
					<div class="col-sm-12 invoice-col mb-15">
						<div class="invoice-details row no-margin">
						  ...
						  <div class="col-md-6 col-lg-3"><b>Payment Due:</b> 14/08/2020</div>
				  ...
				  <div class="row">
					<div class="col-12 text-end">
						<p class="lead"><b>Payment Due</b><span class="text-danger"> 14/08/2020 </span></p>
