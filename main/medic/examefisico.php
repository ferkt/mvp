	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Exame Físico</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Iniciar Consulta</li>
								<li class="breadcrumb-item active" aria-current="page">Exame Físico</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="box">
						<div class="box-body">
							...
							<div class="d-flex align-items-end justify-content-between" style="margin-top: 12px;">
								...
								<a type="button" href="infopac.php?mess=cancel&id_pac=<?php echo $_GET['id_pac']?>"class="waves-effect waves-light btn btn-danger mb-6" _msthash="3547583" _msttexthash="133497"><i class="fa fa-trash" aria-hidden="true"></i> Cancelar</a>
						  	</div>
						</div>
						<!-- ./box-body -->
					</div>
