...
<head>
  <meta charset="utf-8">
    ...
    <title> Exames e procedimentos </title>
            ...
            <a href="#" class="waves-effect waves-light dropdown-toggle w-auto l-h-12 bg-transparent py-0 no-shadow" data-bs-toggle="dropdown" title="User">
				<div class="d-flex pt-5">
					<div class="text-end me-10">
						<p class="pt-5 fs-14 mb-0 fw-700 text-primary">Nome do Médico</p>
  ...
  <div class="content-wrapper">
	  <div class="container-full">
		...
		<section class="content">
		  	<div class="row">
				<div class="col-12">
				<form action="procedAdd.php" method="POST" name="formAdd">
					...
					<div class="box">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-12">
										<input class="form-control" type="date" name="dataProced">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-12">
										<textarea name="descProced" id="textarea" class="form-control" required="" placeholder="Texto da área de texto" _mstplaceholder="410475" aria-invalid="false" style="height: 66px;"></textarea>
									</div>
								</div>	
							</div>
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-12">
										<textarea name="obsProced" id="textarea" class="form-control" required="" placeholder="Texto da área de texto" _mstplaceholder="410475" aria-invalid="false" style="height: 66px;"></textarea>
									</div>
								</div>	
							</div>
							...
							<div class="d-flex align-items-end justify-content-between" col-lg-2" style="margin-top: 12px;">
								...
								<a type="button" href="infopac.php?mess=cancel&<?php echo $_GET['id_pac']?>"class="waves-effect waves-light btn btn-danger mb-6" _msthash="3547583" _msttexthash="133497"><i class="fa fa-trash" aria-hidden="true"></i> Cancelar</a>
						  	</div>
						</div>
						<!-- ./box-body -->
					</div>
