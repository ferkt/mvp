	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Exames e procedimentos</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Iniciar Consulta</li>
								<li class="breadcrumb-item active" aria-current="page">Exames e procedimentos</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="box">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-12">
										<select class="form-control select2" name="descProced"style="width: 100%;">
