				...
				<div class="col-12">
					<div class="box">
					  ...
					  <div class="box-header">
						  <h2 class="box-title" _msthash="2689323" _msttexthash="240565">Nova Consulta</h2>  
					  </div>
					  <div class="box-body">
						  <div class="form-group row">
							  <label class="col-form-label col-md-2" _msthash="3450473" _msttexthash="58058">Titulo Consulta</label>
							  <div class="col-md-10">
								  <input class="form-control" type="email" name="email">
								  <span class="form-text text-muted" _msthash="3274713" _msttexthash="589823">Usando <code _istranslated="1">tipo de entrada="Titulo"</code></span>
							  </div>
						  </div>
	  
						  <div class="form-group row">
							  <label class="col-form-label col-md-2" _msthash="3450720" _msttexthash="25155">Descrição</label>
							  <div class="col-md-10">
								  <input class="form-control" type="url" name="url">
								  <span class="form-text text-muted" _msthash="3274713" _msttexthash="589823">Usando <code _istranslated="1">tipo de entrada="descrição"</code></span>
							  </div>
						  </div>
						  
						  <div class="form-group row">
							<label class="col-form-label col-md-2" _msthash="3449238" _msttexthash="42458">Data</label>
							<div class="col-md-10">
								<input class="form-control" type="date" name="date">
								<span class="form-text text-muted" _msthash="3273387" _msttexthash="619879">Usando <code _istranslated="1">tipo de entrada="data"</code></span>
							</div>
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer modal-footer-uniform">
					...
					<button type="button" class="btn btn-primary float-end">Iniciar Consulta</button>
				</div>
			</div>
		</div>
	</div>
