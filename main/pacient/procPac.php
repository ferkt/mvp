				...
				<div class="col-xl-12 col-12">						
					<div class="box">
						<div class="box-header">
							<h2 class="box-title">Histórico de Exames e Procedimentos</h2>
						</div>
						<div class="box-body">	
							<div class="inner-user-div2">
								<div>
									<?php
										$sql = "SELECT * FROM procedimento WHERE id_paciente = $id_pac order by id_procedimento desc";
