            ...
            <a href="#" class="waves-effect waves-light dropdown-toggle w-auto l-h-12 bg-transparent py-0 no-shadow" data-bs-toggle="dropdown" title="User">
				<div class="d-flex pt-5">
					<div class="text-end me-10">
						<p class="pt-5 fs-14 mb-0 fw-700 text-primary"><?php echo $_SESSION['nome_paciente'] ?></p>
						<small class="fs-10 mb-0 text-uppercase text-mute">Paciente</small>
					</div>
					<img src="../../images/avatar/avatar-png" class="avatar rounded-10 bg-primary-light h-40 w-40" alt="" />
				</div>
            </a>
				...
				<div class="col-xl-12 col-12">						
					<div class="box">
						<div class="box-header">
							<h2 class="box-title">Histórico de Exames Físicos</h2>
						</div>
						<div class="box-body">	
							<div class="inner-user-div2">
								<div>
									<?php
										$sql = "SELECT * FROM exame_fisico WHERE id_paciente = $id_pac order by id_exame desc";
